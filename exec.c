...
bool wpp_do_len (wppExec *exec);
bool wpp_do_getchar (wppExec *exec);
bool wpp_do_setchar (wppExec *exec);
bool wpp_do_exit (wppExec *exec);
bool wpp_do_sleep (wppExec *exec);
bool wpp_do_utime (wppExec *exec);
      ...
      if (main_iteration)
        {
          ...
          DO_TOKEN (WPP_TOKEN_LEN, wpp_do_len);
          DO_TOKEN (WPP_TOKEN_GETCHAR, wpp_do_getchar);
          DO_TOKEN (WPP_TOKEN_SETCHAR, wpp_do_setchar);
          DO_TOKEN (WPP_TOKEN_EXIT, wpp_do_exit);
          DO_TOKEN (WPP_TOKEN_SLEEP, wpp_do_sleep);
          DO_TOKEN (WPP_TOKEN_UTIME, wpp_do_utime);
